...
<body class="font-sans antialiased text-gray-800 bg-white">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="#" class="bg-primary hover:bg-primary-hover text-white px-6 py-3 rounded-md font-medium transition flex items-center gap-2 shadow-sm">
                        Mulai Pinjam Sekarang
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                    </a>
                    <a href="#" class="border border-gray-300 hover:bg-gray-50 text-gray-700 px-6 py-3 rounded-md font-medium transition">
                        Lihat Panduan
                    </a>
                </div>
            </div>
            <div class="relative">
                <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1000&auto=format&fit=crop" alt="Dashboard Mockup" class="rounded-xl shadow-2xl object-cover w-full h-[350px]">
            </div>
        </div>
    </section>
    ...
    <!-- <section class="bg-white py-16">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-3">Mengapa TEMPE IRIS?</h2>
                <p class="text-gray-500">Solusi modern untuk tantangan pengelolaan aset kampus.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                <div class="bg-white border border-gray-200 rounded-xl p-8 shadow-sm">
                    <div class="flex items-center gap-3 mb-6">
                        <div class="bg-red-50 p-2 rounded-full text-red-500 border border-red-100">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        </div>
                        <h3 class="text-lg font-bold text-red-600">Sistem Manual (Lama)</h3>
                    </div>
                    <ul class="space-y-5">
                        <li class="flex gap-3 items-start">
                            <span class="text-red-500 font-bold">✕</span>
                            <div>
                                <h4 class="font-semibold text-gray-900 text-sm">Risiko Kehilangan Dokumen</h4>
                                <p class="text-xs text-gray-500 mt-0.5">Surat fisik sering tercecer atau hilang di tumpukan berkas admin.</p>
                            </div>
                        </li>
                        <li class="flex gap-3 items-start">
                            <span class="text-red-500 font-bold">✕</span>
                            <div>
                                <h4 class="font-semibold text-gray-900 text-sm">Birokrasi Lambat</h4>
                                <p class="text-xs text-gray-500 mt-0.5">Memerlukan tanda tangan basah yang menyita waktu antar departemen.</p>
                            </div>
                        </li>
                        <li class="flex gap-3 items-start">
                            <span class="text-red-500 font-bold">✕</span>
                            <div>
                                <h4 class="font-semibold text-gray-900 text-sm">Data Tidak Akurat</h4>
                                <p class="text-xs text-gray-500 mt-0.5">Sulit mengetahui ketersediaan barang secara real-time.</p>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="bg-primary rounded-xl p-8 text-white shadow-lg">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h3 class="text-lg font-bold">TEMPE IRIS (Digital)</h3>
                    </div>
                    <ul class="space-y-5">
                        <li class="flex gap-3 items-start">
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-2">Fitur Unggulan</h2>
                <p class="text-gray-500 text-sm">Solusi komprehensif untuk setiap stakeholder di lingkungan FMIPA.</p>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-bg-light p-6 rounded-xl border border-gray-100">
                    <div class="bg-white w-10 h-10 rounded-lg flex items-center justify-center mb-4 text-primary shadow-sm">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                    </div>
                    <h3 class="font-bold text-gray-900 mb-2 text-sm">Hak Akses Spesifik</h3>
                    <p class="text-xs text-gray-500 leading-relaxed">Dashboard khusus untuk Mahasiswa, Admin LM, hingga Dekanat dengan izin yang terenkripsi.</p>
                </div>
                <div class="bg-bg-light p-6 rounded-xl border border-gray-100">
                    <div class="bg-white w-10 h-10 rounded-lg flex items-center justify-center mb-4 text-primary shadow-sm">
                    ...
                    <h3 class="font-bold text-gray-900 mb-2 text-sm">Validasi Multi-Level</h3>
                    <p class="text-xs text-gray-500 leading-relaxed">Alur persetujuan hierarkis yang menyesuaikan regulasi birokrasi universitas secara otomatis.</p>
                </div>
                <div class="bg-bg-light p-6 rounded-xl border border-gray-100">
                    <div class="bg-white w-10 h-10 rounded-lg flex items-center justify-center mb-4 text-primary shadow-sm">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    </div>
                    <h3 class="font-bold text-gray-900 mb-2 text-sm">Surat Otomatis</h3>
                    <p class="text-xs text-gray-500 leading-relaxed">Hasilkan formulir peminjaman dalam format PDF secara instan setelah disetujui oleh atasan.</p>
                </div>
                <div class="bg-bg-light p-6 rounded-xl border border-gray-100">
                    <div class="bg-white w-10 h-10 rounded-lg flex items-center justify-center mb-4 text-primary shadow-sm">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                    </div>
                    <h3 class="font-bold text-gray-900 mb-2 text-sm">Tracking Real-Time</h3>
                    <p class="text-xs text-gray-500 leading-relaxed">Monitoring pergerakan barang dan status ketersediaan inventaris secara langsung di peta digital.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-bg-light py-16">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-bold text-gray-900 mb-2">Bagaimana Cara Meminjam?</h2>
                <p class="text-gray-500 text-sm">Proses mudah hanya dalam 4 langkah sederhana.</p>
            </div>
    ...
    <section class="bg-bg-light pb-24 px-6">
