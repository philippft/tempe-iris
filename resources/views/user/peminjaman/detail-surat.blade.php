...
<x-header-page title="Peminjaman" :href="route('user.peminjaman.index')" />
    ...
    <div class="flex justify-between items-center">
        <div>
            <div class="flex items-center gap-3 mb-2">
                ...
                <x-badge :status="is_null($surat->tandatangan_pimpinan)
                    ? 'pending'
                    : ($surat->tandatangan_pimpinan == 1 ? 'aktif' : 'ditolak')" />
            </div>
        ...
        <x-button
            href="{{ route('user.preview.surat', $surat) }}"
            variant="tersier"
