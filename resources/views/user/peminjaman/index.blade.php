...
<div class="space-y-8 p-8">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a href="{{ route('user.peminjaman.create') }}"
                    class="text-white bg-primary-hover px-4 py-2.5 text-base font-bold rounded-lg shadow-sm hover:bg-primary transition flex items-center gap-2">
    ...
    <x-container>
        ...
        >
            @forelse($peminjaman as $surat)
                ...
                @empty
                <x-table-empty message="Saat ini tidak ada peminjaman yang sedang dilakukan atau tidak ada data yang cocok dengan pencarian Anda."/>
            @endforelse
        </x-table>
    </x-container>
</div>
