...
<nav class="fixed top-0 left-0 right-0 w-full z-50 bg-bg-light border-b-2 border-border-custom px-6 py-4">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <a href="#beranda" class="{{ $active === 'beranda' ? 'text-primary border-b-2 border-primary pb-1' : 'hover:text-primary transition' }}">Beranda</a>
