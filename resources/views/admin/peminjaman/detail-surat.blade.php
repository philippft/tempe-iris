...
<div class="p-8 space-y-8">
     <a href="{{ route('admin.peminjaman.index') }}" class="font-extrabold text-primary-hover hover:underline transition text-4xl space-y-0!">
        ←
    </a>
    {{-- Header --}}
    <div class="flex justify-between items-center">
        ...
        <x-button href="{{ route('user.preview.surat', $surat) }}" variant="tersier" class="flex items-center gap-2">
