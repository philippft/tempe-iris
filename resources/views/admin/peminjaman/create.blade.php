...
<body class="bg-[#F8FAFC]">
    ...
    <form action="{{ route('admin.peminjaman.detail') }}" method="POST">
        @csrf
    ...
    <script>
        ...
        function applyFilters() {
            ...
            // Memanggil route halaman create itu sendiri dengan query parameter
            window.location.href =
                `/admin/peminjaman/create?id_tujuan=${idTujuan}&search=${encodeURIComponent(search)}&category_id=${categoryId}`;
        }
