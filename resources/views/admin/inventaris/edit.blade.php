...
<form
    action="{{ route('admin.inventaris.update', $inventaris) }}"
    method="POST"
    ...
    <div class="flex justify-end gap-4">
        <a href="{{ route('admin.inventaris.show', $inventaris) }}" class="rounded-xl border border-border-custom px-8 py-3 font-semibold hover:bg-slate-100 transition">
            Batal
        </a>
        <div>
        <button
