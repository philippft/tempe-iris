...
<div class="p-8 space-y-9">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div>
            ...
            @elseif($user->note && $user->verify_at == null)
                <x-badge label1="ditolak" variant="red"/>
            @elseif($user->note == null && $user->verify_at == null)
                <x-badge label1="pending" variant="yellow"/>
            @endif
        </div>
    </div>
...
<!-- page philip dan temannya, jangan lupa hapus guys -->
